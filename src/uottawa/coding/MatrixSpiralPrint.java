...
public class MatrixSpiralPrint {
    private static int[][] arr = { { 1, 2, 3, 4, 20 }, { 5, 6, 7, 8, 30 }, { 9, 10, 11, 12, 40 },
            { 13, 14, 15, 16, 50 }, { 60, 70, 80, 90, 100 } };

    public static void main(String[] args) {
        spiralPrint(arr, 5);
        System.out.println();
        spiralPrintInside(arr, 5);
    }
    ...
    private static void spiralPrintInside(int[][] arr2, int n) {
        int layers = n / 2;
